...
Contains the code implementation and example scripts for the manuscript titled *Orthogonal-by-construction augmentation of physics-based input-output models* (currently submitted for publication).
